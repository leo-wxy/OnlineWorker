  ...
  return (
    <div className="space-y-6">
      <div className="ow-page-frame rounded-[26px] p-5">
        ...
        <div className="mt-4 rounded-2xl border border-[var(--ow-line)] bg-[var(--ow-panel-soft)] p-4">
          <div className="flex items-center gap-3">
            <div className="grid h-10 w-10 place-items-center rounded-2xl bg-[var(--ow-blue-soft)] text-[var(--ow-blue)]">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221l-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.446 1.394c-.14.18-.357.295-.6.295-.002 0-.003 0-.005 0l.213-3.054 5.56-5.022c.24-.213-.054-.334-.373-.121l-6.869 4.326-2.96-.924c-.64-.203-.658-.64.135-.954l11.566-4.458c.538-.196 1.006.128.832.94z" />
              </svg>
            </div>
            <div className="min-w-0">
              <p className="text-sm font-semibold text-[var(--ow-text)]">{texts.dashboard.telegramLabel}</p>
          ...
          <div className="mt-4 grid gap-3">
            <div>
              ...
              <p className="mt-1 text-sm font-semibold text-[var(--ow-text)]">
        ...
        <div className="space-y-3">
          {canOpenProviderTuiHost && (
            <button
              ...
              className="group flex w-full items-center gap-4 rounded-2xl border border-[var(--ow-line)] bg-[var(--ow-panel-soft)] p-4 text-left transition-colors hover:border-[var(--ow-green)] hover:bg-[var(--ow-green-soft)]"
            >
              <div className="grid h-11 w-11 shrink-0 place-items-center rounded-2xl bg-[var(--ow-green-soft)] text-[var(--ow-green)]">
              ...
              <div className="min-w-0">
                <h4 className="font-semibold text-[var(--ow-text)] group-hover:text-[var(--ow-green)]">
                  {texts.dashboard.openCliHostTitle}
                </h4>
                <p className="mt-1 text-xs leading-5 text-[var(--ow-muted)]">
...
const quickActionTones = {
  blue: {
    hover: "hover:border-[var(--ow-blue)] hover:bg-[var(--ow-blue-soft)]",
    icon: "bg-[var(--ow-blue-soft)] text-[var(--ow-blue)]",
    title: "group-hover:text-[var(--ow-blue)]",
  },
  violet: {
    hover: "hover:border-[var(--ow-purple)] hover:bg-[var(--ow-purple-soft)]",
    icon: "bg-[var(--ow-purple-soft)] text-[var(--ow-purple)]",
    title: "group-hover:text-[var(--ow-purple)]",
  },
  amber: {
    hover: "hover:border-[var(--ow-amber)] hover:bg-[var(--ow-amber-soft)]",
    icon: "bg-[var(--ow-amber-soft)] text-[var(--ow-warning-text)]",
    title: "group-hover:text-[var(--ow-warning-text)]",
  },
};
...
function QuickAction({
  ...
  return (
    <button
      onClick={onClick}
      className={`group flex w-full items-center gap-4 rounded-2xl border border-[var(--ow-line)] bg-[var(--ow-panel-soft)] p-4 text-left transition-colors ${styles.hover}`}
    >
      ...
      <div className="min-w-0">
        <h4 className={`font-semibold text-[var(--ow-text)] ${styles.title}`}>{title}</h4>
        <p className="mt-1 text-xs leading-5 text-[var(--ow-muted)]">{description}</p>
      </div>
    </button>
  );
}
