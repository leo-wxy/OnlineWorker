...
export const enTexts: AppTexts = {
    ...
    setup: {
      ...
      diagnosticsTitle: "Diagnostics and Support Bundle",
      ...
      diagnosticsError: (error: string) => `Diagnostics failed: ${error}`,
      ...
      diagnosticsCopied: "Diagnostic summary copied.",
      exportSupportBundle: "Export Support Bundle",
      supportBundleExporting: "Exporting...",
      supportBundleExported: (path: string) => `Support bundle saved: ${path}`,
      supportBundleError: (error: string) => `Support bundle operation failed: ${error}`,
      revealSupportBundle: "Show in Finder",
    ...
    sessions: {
      ...
      newSessionHint: "Create a new provider session in the current workspace",
      newSessionNoWorkspace: "No workspace is available. Select or load a workspace first.",
      createSessionFailed: (error: string) => `Create session failed: ${error}`,
    ...
    providerSettings: {
      ...
      externalCliProxyAliasDescription: "Connect through OnlineWorker's managed remote proxy while keeping native CLI approval prompts mirrored to TG.",
    ...
    ai: {
      ...
      servicesDescription: "Built-in services come from plugin manifests; this page only renders and edits them.",
      ...
      providerLoginAuthentication: (provider: string) => `Uses the authenticated ${provider} CLI account`,
      providerDefaultModel: "Uses the provider's current default model",
      apiKey: "API Key",
      ...
      loginReady: "Logged in",
      loginUnavailable: "Logged out",
      ...
      loginCheckOk: (message: string) => `Login check passed: ${message}`,
      loginCheckFailed: (message: string) => `Login check failed: ${message}`,
      enabled: "Enabled",
      disabled: "Disabled",
    ...
    dashboard: {
      ...
      openSessionsDescription: "Browse provider sessions",
      openCliHostTitle: "Open Provider CLI",
      openCliHostDescription: "Open a visible CLI approval path for the active provider session",
