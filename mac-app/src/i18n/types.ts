...
export interface AppTexts {
  ...
  setup: {
    ...
    supportBundlePrivacy: string;
    runDiagnostics: string;
    diagnosticsRunning: string;
    diagnosticsNeverRun: string;
    diagnosticsError: (error: string) => string;
    diagnosticsStatusPass: string;
    diagnosticsStatusWarning: string;
    diagnosticsStatusFail: string;
    diagnosticsShowDetails: string;
    diagnosticsHideDetails: string;
    diagnosticsRemediation: string;
    copyDiagnostics: string;
    diagnosticsCopied: string;
    exportSupportBundle: string;
    supportBundleExporting: string;
    supportBundleExported: (path: string) => string;
    supportBundleError: (error: string) => string;
    revealSupportBundle: string;
  ...
  sessions: {
    ...
    archiveFailed: (error: string) => string;
  };
  usage: {
    title: string;
    description: string;
  ...
  ai: {
    ...
    scenarioConfigTitle: string;
    scenarioDetailDescription: string;
    enableService: string;
    enableScenario: string;
    deleteService: string;
    authentication: string;
    providerLoginAuthentication: (provider: string) => string;
    ...
    connectionOk: (status: string) => string;
    connectionFailed: (status: string, message: string) => string;
    loginCheckOk: (message: string) => string;
    loginCheckFailed: (message: string) => string;
    enabled: string;
    disabled: string;
    defaultModel: string;
    timeout: string;
